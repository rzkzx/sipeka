                ...
                <div class="tab-content">
                  <div id="about-me" class="tab-pane fade active show">
                    <div class="profile-personal-info">
                      ...
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Pangkat<span class="pull-right">:</span></h5>
                        </div>
                      ...
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Ruangan<span class="pull-right">:</span></h5>
                        </div>
                      ...
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-9 col-7"><span><?= $data['pegawai']->masa_kerja ?></span>
                        </div>
                      </div>
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                      ...
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Pangkat Berikutnya<span class="pull-right">:</span></h5>
                        </div>
                        <div class="col-sm-9 col-7"><span><?= $data['pegawai']->pangkat_berikutnya ?></span>
                        </div>
                      </div>
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Periode Pangkat Berikutnya<span class="pull-right">:</span></h5>
                        </div>
                        <div class="col-sm-9 col-7"><span><?= dateID($data['pegawai']->periode_pkt_berikutnya) ?></span>
                        </div>
                      </div>
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                      ...
                      <div class="settings-form">
                        <div class="row">
                          <div class="col-xl-8">
                            ...
                            <br>
                            <form method="post" action="<?= URLROOT ?>/profile/changeProfileUser" enctype="multipart/form-data">
                              <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                  <label>Jabatan</label>
                                  <input type="text" name="jabatan" id="jabatan" class="form-control" value="<?= $data['pegawai']->jabatan ?>" required>
                                </div>
                                <div class="form-group col-md-6">
                                  <label>Ruangan</label>
