              ...
              <form method="post" id="form-valide" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input name="tgl_surat" id="tgl_surat" class="datepicker-default form-control" id="datepicker" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Nama</label>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="pangkat_terakhir" id="pangkat_terakhir" class="form-control" required readonly>
                  </div>
                  <div class="form-group col-md-6">
                    <label>TMT Pangkat Terakhir</label>
                    <input type="text" name="tmt_pangkat_terakhir" id="tmt_pangkat_terakhir" class="form-control" required readonly>
                  </div>
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input name="periode_usulan" id="periode_usulan" class="datepicker-default form-control" id="datepicker" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Status</label>
                    <input name="status" id="status" class="form-control" value="Usulan" readonly>
                  </div>
                  <div class="form-group col-md-6">
                    <label>File PDF</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="file_usulpangkat" id="file_usulpangkat" class="custom-file-input" required>
